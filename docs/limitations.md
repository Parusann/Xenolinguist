...
Next packages add number grammar inference, first-class evidence relationships and validated model research proposals. See [implementation progress](implementation-progress.md).
