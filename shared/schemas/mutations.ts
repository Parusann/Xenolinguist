...
export const profileFieldsSchema = profileDataSchema.pick({ name: true, description: true, phonetic_notes: true, is_sandbox: true, sandbox_difficulty: true, sandbox_session: true, ai_history: true, lexical_policy: true }).partial();
