...
export const DEMO_LANGUAGE: Omit<LanguageProfile, 'id' | 'created_at' | 'updated_at'> = {
  ...
  samples: [
    { id: 'sample-1', alien_text: 'ka nesh lor', english_translation: 'I see the star', source: 'Direct communication', phonetic_notes: '/ka neʃ lor/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-2', alien_text: 'vel tor krash', english_translation: 'water falls from the sky', source: 'Overheard conversation', phonetic_notes: '/vel tor kraʃ/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-3', alien_text: 'ka ix mok', english_translation: 'I do not speak', source: 'Direct communication', phonetic_notes: '/ka iks mok/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-4', alien_text: 'nesh-en shu', english_translation: 'the great stars', source: 'Written inscription', phonetic_notes: '/neʃ.en ʃu/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-5', alien_text: 'ka ven zo', english_translation: 'you and I', source: 'Direct communication', phonetic_notes: '/ka ven zo/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-6', alien_text: 'sa ren ku vol', english_translation: 'one two three four', source: 'Radio signal', phonetic_notes: '/sa ren ku vol/', decoded: true, audio_id: null, created_at: T },
    { id: 'sample-7', alien_text: 'thume kor ral nakto', english_translation: null, source: 'Radio signal', phonetic_notes: '/θume kor ral nakto/', decoded: false, audio_id: null, created_at: T },
    { id: 'sample-8', alien_text: 'zo dru lor ix vaela', english_translation: null, source: 'Overheard conversation', phonetic_notes: '/zo dru lor iks vaela/', decoded: false, audio_id: null, created_at: T },
  ],
  audio_clips: [],
};
